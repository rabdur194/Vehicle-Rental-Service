      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <p>You wish we Deliver..... </p>
            <a href="car-listing.php" class="btn">Learn Details <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p style="margin-left: 100px;margin-right: 80px;">We have varities of cars containing large seat capacities and couple seaters.you can search for cars you wish in the search box and you can get your desired cars.small,big whatever is your preferences.we got you covered.Choose according to your choice.If you are satisfies with our service please provide a feedback.</p>
    </div>
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Newly Added Cars</a></li>
        </ul>
      </div>
